        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mt-1">{{ $isEdit ? 'Update your budget details' : 'Set
                        spending limits for better financial control' }}</p>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-blue-800 space-y-1">
                            ...
                            @else
                            <li>• <strong>Category budgets:</strong> Get detailed control over specific spending areas
                            </li>
                            @endif
                        </ul>
                    </div>
