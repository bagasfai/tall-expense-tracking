<div class="min-h-screen bg-gray-50 dark:bg-neutral-900 rounded">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <a href="/budgets" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition self-end sm:self-auto">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form wire:submit="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select wire:model="month"
                                id="month"
                                class="w-full px-4 py-3 border dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('month') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <select wire:model="year"
                                id="year"
                                class="w-full px-4 py-3 border dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('year') border-red-500 @enderror">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select wire:model="category_id"
                                id="category_id"
                                class="w-full px-4 py-3 border dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('category_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   min="0"
                                   placeholder="0.00"
                                   class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-lg @error('amount') border-red-500 @enderror">
                        </div>
                        @error('amount')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    @if($showAIRecommendation && $aiRecommendation)
                        <div class="relative bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 dark:from-purple-900/30 dark:via-indigo-900/30 dark:to-blue-900/30 border-2 border-purple-200 dark:border-purple-700 rounded-xl p-4 sm:p-6 shadow-lg">
                            <!-- Close Button -->
                            <button type="button"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-4">
                                <button type="button"
                                        ...
                                        class="p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-600 hover:border-purple-400 dark:hover:border-purple-500 hover:shadow-md transition text-center">
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">Conservative</p>
                                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">${{ number_format($aiRecommendation['min'], 0) }}</p>
                                </button>

                                <button type="button"
                                        wire:click="applyRecommendation('recommended')"
                                        class="p-3 sm:p-4 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg text-white hover:shadow-xl transition text-center transform hover:scale-105">
                                    <p class="text-xs mb-1 opacity-90">Recommended</p>
                                    <p class="text-xl sm:text-2xl font-bold">${{ number_format($aiRecommendation['recommended'], 0) }}</p>
                                </button>

                                <button type="button"
                                        wire:click="applyRecommendation('max')"
                                        class="p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-600 hover:border-purple-400 dark:hover:border-purple-500 hover:shadow-md transition text-center">
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">Comfortable</p>
                                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">${{ number_format($aiRecommendation['max'], 0) }}</p>
                                </button>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-4 mb-3">
                                <p class="text-sm text-gray-800 dark:text-gray-200 leading-relaxed">
                                    <strong class="text-purple-700 dark:text-purple-400">Why this amount:</strong> {{ $aiRecommendation['explanation'] }}
                                </p>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border-l-4 border-green-500">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-semibold text-green-900 dark:text-green-300 mb-1">💡 Pro Tip</p>
                    ...
                    @if($amount && $month && $year)
                        <div class="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 rounded-lg border-2 border-indigo-200 dark:border-indigo-700">
                            <p class="text-sm font-medium text-indigo-900 dark:text-indigo-300 mb-2">Budget Preview:</p>
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                <div>
                                    <p class="text-xl sm:text-2xl font-bold text-indigo-900 dark:text-indigo-200">${{ number_format($amount, 2) }}</p>
            ...
            <!-- Tips Card -->
            <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-6">
                <div class="flex items-start gap-3">
            ...
            <div class="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3">
                <a href="/budgets" class="px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition text-center">
                    Cancel
                </a>
                <button type="submit" 
                        class="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
